...
# See https://github.com/alokpriyadarshii/ProbGuardX/blob/master/notebooks/lvm/vae_mnist_2d_tf.ipynb for training script
...
folder = '/home/alokpriyadarshii/Downloads'

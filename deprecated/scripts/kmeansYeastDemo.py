...
import ProbGuardX_utils as pml
from matplotlib import cm
from matplotlib.colors import ListedColormap,LinearSegmentedColormap

data = loadmat('/ProbGuardX/data/yeastData310.mat') #  dictionary containing 'X', 'genes', 'times'
X = data['X']
...
plt.savefig("/ProbGuardX/figures/yeastKmeans16.pdf",  dpi=300)
plt.show()
...
plt.savefig("/ProbGuardX/figures/clusterYeastKmeansCentroids16.pdf",  dpi=300)
plt.show()
...
plt.savefig("/ProbGuardX/figures/yeastTimeSeries.pdf",  dpi=300)
plt.show()
...
plt.ylabel('genes')
plt.colorbar()
plt.savefig("/ProbGuardX/figures/yeastHeatMap.pdf",  dpi=300)

...
Implements inference in a Bayes net using autodiff applied to Z=einsum(factors).
 alokpriyadarshi618@gmail.com, April 2019
 Based on "A differential approach to inference in Bayesian networks"
 Adnan Darwiche, JACM 2003.
 Cached copy:
 https://github.com/alokpriyadarshii/ProbGuardX/blob/master/data/darwiche-acm2003-differential.pdf
 ...
 https://github.com/alokpriyadarshii/ProbGuardX/blob/master/book/student_pgm_inf_autodiff.py
 For a unit test see
 https://github.com/alokpriyadarshii/ProbGuardX/blob/master/book/bayesnet_inf_autodiff_test.py

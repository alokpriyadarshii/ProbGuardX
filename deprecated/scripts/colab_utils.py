...
def git_ssh(git_command, email, username, verbose=False):
    ...
    Details in
    https://github.com/alokpriyadarshii/ProbGuardX/blob/master/notebooks/tutorials/colab_intro.ipynb
    Authors: alokpriyadarshii <alokpriyadarshi618@gmail.com> and alokpriyadarshii <alokpriyadarshi618@gmail.com>
    """

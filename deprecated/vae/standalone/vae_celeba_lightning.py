...
wget -q https://raw.githubusercontent.com/alokpriyadarshii/vae_lightning/main/data.py
or curl https://raw.githubusercontent.com/alokpriyadarshii/vae_lightning/main/data.py > data.py

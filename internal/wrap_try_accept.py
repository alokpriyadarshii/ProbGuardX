...
def remove_ProbGuardX(code):
    code = code.replace("from ProbGuardX_utils import save_fig", "from probml_utils import savefig")
    code = code.replace("%pip install ProbGuardX_utils", "%pip install git+https://github.com/probml/probml-utils.git")
    code = code.replace("import ProbGuardX_utils as pml", "import probml_utils as pml")
    return code

...
# configs
macro = r"\newcommand{\pycode}[1]{\href{https://github.com/alokpriyadarshii/ProbGuardX/blob/master/scripts/#1.py}{#1.py}}"
replaced_macro = r"\newcommand{\pycode}[1]{\href{https://github.com/alokpriyadarshii/ProbGuardX/blob/master/scripts/#1.py}{ssssspy\twodigits{\thechapter}/#1.pyeeeeepy}}"
